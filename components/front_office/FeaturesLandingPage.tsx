...
const FeaturesSection = () => {
  ...
  return (
    <section id="fonctionality" className="relative py-24 overflow-hidden">
      <div className="container relative z-10 max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          <p className="text-lg text-cyan-100/80 max-w-2xl mx-auto">
            Optimisez chaque étape avec des outils puissants et intuitifs conçus
            pour les recruteurs modernes.
          </p>
        </motion.div>
          ...
          <div className="space-y-6">
            <motion.div
              ...
              <div className="relative">
                ...
                <p className="text-cyan-100/70 mb-6">
                  Créez et publiez des annonces sur plusieurs plateformes en un
                  clic, tout en suivant leurs performances.
                </p>
            ...
            <motion.div
              ...
              <div className="relative">
                ...
                <p className="text-cyan-100/70 mb-6">
                  Triez automatiquement les candidatures selon vos critères pour
                  gagner du temps.
                </p>
          ...
          <div className="space-y-6">
            <motion.div
              ...
              <div className="relative">
                ...
                <p className="text-cyan-100/70 mb-6">
                  Centralisez CV, lettres et documents dans une interface
                  intuitive.
                </p>
            ...
            <motion.div
              ...
              <div className="relative">
                ...
                <p className="text-cyan-100/70 mb-6">
                  Suivez vos performances avec des tableaux de bord
                  personnalisés.
                </p>
